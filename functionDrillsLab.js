...
const compareNums1 = (num1, num2) => num1 > num2 ? num1 : num2
...
function thatsOdd(num) {
  num % 2 === 0 ? console.log("That's not odd!") : console.log('That is odd indeed!')
}
...
console.log(theEliminator(['Katniss', 'Peeta', 'Fox-face', 'Glimmer', 'Cato', 'Rue', 'Thresh', 'Clove', 'Marvel'], 'Glimmer'))
...
console.log(emailCheck('     shawtina@yahoo.com'))
